...
public record S2CSendPicturePacket(String hash, byte[] data, int index, int totalPacket, int totalLength,
                                   PictureFormat format) {

    public static S2CSendPicturePacket decode(FriendlyByteBuf buf) {
    ...
    public static void handle(S2CSendPicturePacket packet, Supplier<NetworkEvent.Context> ctx) {
